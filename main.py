  ...
  while True:
    ...
    for face in faces:
      ...
      for s in shape_2d:
        ...
        elif (point_number >= 36 and point_number <= 39):  # left Abobe Part
    ...
    U.get_cheek_layer(cheek_ori, points_for_leftcheek, points_for_rightcheek, face_line, points_for_nosecheek[0][0], R,
                      G, B, cheek_max_alpha)
...
if __name__ == '__main__':
    print("## AI Layer Extraction ##")
    print("Build : 20-08-17")
    print("Version : 1.0.0v")
    print("input, output folder must be placed in current directory")
    start()
# Picture FileName