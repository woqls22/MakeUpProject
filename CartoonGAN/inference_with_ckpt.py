...
if __name__ == "__main__":
    ...
    parser.add_argument("--m_path", type=str, default="./light_shinkai_ckpt")
    parser.add_argument("--img_path", type=str,
                        default=os.path.join("input_images", "temple.jpg"))
    parser.add_argument("--out_dir", type=str, default='./output_images/')
    parser.add_argument("--light",default="--light", action='store_true')
    args = parser.parse_args()
    while(True):
        print("Enter the ImageName[PATH : /source/]")
        file=input()
        inputName = "./source/"+file
        try:
            main(args.m_path, inputName, args.out_dir, args.light)
        except:
            pass